...
log_level = 'INFO'
load_from = './work_dirs/res50_gaze_256x256_first_stage/best_NME_epoch_95.pth'
resume_from = None
resume_optimizer = False
dist_params = dict(backend='nccl')
workflow = [('train', 1)]
checkpoint_config = dict(interval=10)
evaluation = dict(interval=5, metric=['gaze_loss'], save_best='gaze_loss')
...
train_pipeline = [
    ...
    dict(
        type='TopDownGetRandomScaleRotation', rot_factor=0,
        scale_factor=0.25),
